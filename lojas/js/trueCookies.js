var purecookieTitle="Aviso sobre o uso de Cookies!",
purecookieDesc="Ao navegar por esse site, automaticamente está ciente do uso de cookies.",
purecookieLink='<a href="#" target="_blank">Para quê?</a>',
purecookieButton="Entendi, ok!";
function pureFadeIn(e,o){
	var i=document.getElementById(e);i.style.opacity=0,i.style.display=o||"block",function e(){var o=parseFloat(i.style.opacity);(o+=.02)>1||(i.style.opacity=o,requestAnimationFrame(e))}()}function pureFadeOut(e){
...
function setCookie(e,o,i){var t="";
	if(i){var n=new Date;n.setTime(n.getTime()+24*i*60*60*1e3),t="; expires="+n.toUTCString()}
